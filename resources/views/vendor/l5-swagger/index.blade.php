...
<body @if(config('l5-swagger.defaults.ui.display.dark_mode')) id="dark-mode" @endif>
    <div class="api-token-container">
        <label for="apiToken" class="api-token-label">API Token:</label>
        <input type="text" id="apiToken" class="api-token-input" placeholder="Enter your API token">
    </div>
    ...
    <script>
        window.onload = function() {
            const ui = SwaggerUIBundle({
                dom_id: '#swagger-ui',
                urls: {!! json_encode(
                    collect($urlsToDocs)->map(function($url, $title) {
